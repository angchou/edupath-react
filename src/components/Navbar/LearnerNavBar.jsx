...
export default function LearnerNavBar() {
  ...
  const items = [
    { id: "home", label: "Home", path: "/learner/home" },
    { id: "courses", label: "Courses", path: "/learner/courses" },
    { id: "route", label: "Route", path: "/learner/route" },
    { id: "contact", label: "Contact Us", path: "/learner/contact" },
  ];
